...
FORBIDDEN_IMPORTS = {
    ...
    "agents": {"api", "evaluation", "notebooks", "orchestration", "services"},
    "services": {"api", "evaluation", "notebooks", "orchestration", "runtime"},
    "governance": {"api", "evaluation", "notebooks", "orchestration", "services"},
    "orchestration": {"api", "evaluation", "notebooks", "runtime"},
}
