...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-bold transition-colors outline-none disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
  ...
  (
    ...
    return (
      <Comp
        ...
        ref={ref}
        title={title || controlHint(children, ariaLabel)}
        aria-label={ariaLabel}
        {...props}
      >
        {children}
